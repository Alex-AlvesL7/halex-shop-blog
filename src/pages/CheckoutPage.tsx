          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-start">
            ...
            <div className="lg:sticky lg:top-24 space-y-6">
              <div className="rounded-[32px] p-8 shadow-2xl bg-brand-black text-white">
                ...
                <div className="mt-4 text-xs leading-relaxed text-gray-400">Seus dados de contato e entrega serão usados para processar, acompanhar e comunicar atualizações do seu pedido.</div>
              </div>
